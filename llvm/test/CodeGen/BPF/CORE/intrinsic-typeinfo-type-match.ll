...
entry:
  %0 = tail call i32 @llvm.bpf.preserve.type.info(i32 0, i64 2), !dbg !19, !llvm.preserve.access.index !8
  %1 = tail call i32 @llvm.bpf.preserve.type.info(i32 1, i64 2), !dbg !20, !llvm.preserve.access.index !21
  %add = add i32 %1, %0, !dbg !27
  %2 = tail call i32 @llvm.bpf.preserve.type.info(i32 2, i64 2), !dbg !28, !llvm.preserve.access.index !3
